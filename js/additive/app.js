...
function updateAttack() {
  engine.adsr.attack = document.getElementById("attack").value / 500;
}
function updateDecay() {
  engine.adsr.decay = document.getElementById("decay").value / 500;
}
function updateSustain() {
  engine.adsr.sustain = document.getElementById("sustain").value / 100;
}
function updateRelease() {
  engine.adsr.release = document.getElementById("release").value / 250;
}
function updateReverb() {
  engine.setReverb(document.getElementById("reverb").value / 100);
}
function updateVolume() {
  engine.setVolume(document.getElementById("vol").value / 100);
}
