...
*/
  ...
  if (log) knob.setAttribute("log", true);
  else knob.setAttribute("step", (max - min) / 100);
  if (units) knob.setAttribute("units", units);
...
function setupSynthUI() {
  ...
  osc1.appendChild(
    createDropdown(
      ...
      10,
      15,
      ["sine", "square", "saw", "triangle" /*, "wavetable"*/],
      currentOsc1Waveform,
      onUpdateOsc1Wave,
    ),
  );
