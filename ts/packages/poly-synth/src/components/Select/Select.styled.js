...
import { relaBlock, relaInline, absFill, vertCenter } from "src/styles/util";
...
export const Input = styled.div`
  ...
  overflow: hidden;
  border: ${borderWidthM} solid
    ${({ theme, isDropdownOpen }) =>
      isDropdownOpen ? theme.strong : theme.mid};
  background-color: ${({ theme, isDropdownOpen }) =>
    isDropdownOpen ? theme.mid : "transparent"};
